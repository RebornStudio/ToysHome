...
export class AddressPage {
	...
	constructor(public translate: TranslateService,public navCtrl: NavController, private navParams: NavParams, public modalCtrl: ModalController, public viewCtrl: ViewController, private toastCtrl: ToastController) {
