...
export class CategoryPage {
	...
	constructor(public translate: TranslateService,public navCtrl: NavController, public modalCtrl: ModalController, private service: WordpressClient, private toastCtrl: ToastController) {
	...
	setupCategories(savedCats: Array<Category>) {
		let catsToShow = new Array<Array<Category>>();
